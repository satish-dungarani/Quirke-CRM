...
{
    /// <inheritdoc />
    public partial class QuirkeCRM_8924 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsIdentityProvided = table.Column<bool>(type: "bit", nullable: false),
                    IsAllergicToColour = table.Column<bool>(type: "bit", nullable: false),
                    AllergicColourDetails = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    IsDamagedScalp = table.Column<bool>(type: "bit", nullable: false),
                    ScalpDetails = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    HasTattoo = table.Column<bool>(type: "bit", nullable: false),
                    TattooDetails = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    IsAllergicToProduct = table.Column<bool>(type: "bit", nullable: false),
                    AllergicProductDetails = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanTakeService = table.Column<bool>(type: "bit", nullable: false),
                    IsAllergyTestDone = table.Column<bool>(type: "bit", nullable: false),
                    TestScheduleOn = table.Column<DateTime>(type: "datetime", nullable: true),
                    TestDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    ObservedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "datetime", nullable: true),
                    SignatureData = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SalonSignatureData = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveDuration = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Masters_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Masters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DevTime = table.Column<string>(type: "nvarchar(max)", nullable: true),
